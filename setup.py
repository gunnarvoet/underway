...
setup(
    ...
    url="https://github.com/gunnarvoet/rbr",
    license="MIT License",
    # Description
    description="ship underway data handling",
    ...
    # Packaging
    packages=find_packages(include=["underway", "underway.*"], exclude=["*.tests"]),
    # package_data={"rbr": ["tests/data/*.rsk"]},
